    ...
    <button
      ...
      className={`w-9 h-9 flex items-center justify-center rounded-full transition-all ${
        presentationTool === 'laser'
          ? 'bg-red-500/15 border border-red-500/30 shadow-md shadow-red-500/10'
          : 'bg-[#12121f] border border-[#2a2a4e] hover:border-blue-500/30'
      }`}
  ...
  return (
        ...
        <Link to={site.basePath || '/'} className="flex items-center gap-3 group">
          ...
          <div>
            <h1 className="text-xl font-bold text-gray-100 leading-tight">
              {site.brandName}<span className="text-blue-400">{site.brandAccent}</span>
            </h1>
            {site.brandSubtitle && (
        ...
        <div className="flex items-center gap-4">
            ...
            <div className="relative hidden sm:block">
              <div className="flex items-center bg-[#12121f] border border-[#2a2a4e] rounded-xl px-4 py-2.5 w-64 lg:w-80 focus-within:border-blue-500 focus-within:ring-2 focus-within:ring-blue-500/20 transition-all">
                ...
                <input
                  type="text"
                  placeholder="Search..."
                  className="bg-transparent outline-none text-sm text-gray-200 placeholder-gray-600 w-full"
                  value={searchQuery}
          ...
          {isLocalhost && !isPresenting && (
            <button
              ...
              className="flex items-center gap-2 bg-blue-500/10 hover:bg-blue-500/20 text-blue-400 px-4 py-2.5 rounded-xl transition-colors text-sm font-medium border border-blue-500/30"
            >
          ...
          {!isLocalhost && (
            <a
              ...
              className="flex items-center gap-2 bg-red-500/10 hover:bg-red-500/20 text-red-400 px-4 py-2.5 rounded-xl transition-colors text-sm font-medium border border-red-500/30"
            >
    ...
    {showAbout && (
      <div className="fixed inset-0 z-[99999] bg-black/50 flex items-center justify-center p-12" onClick={() => setShowAbout(false)}>
        <div className="bg-[#12121f] rounded-2xl max-w-xl w-full max-h-[70vh] overflow-y-auto p-8 shadow-2xl border border-[#2a2a4e]" onClick={e => e.stopPropagation()}>
          <div className="flex items-center justify-between mb-5">
            <h2 className="text-lg font-bold text-gray-100">How This Works</h2>
            <button onClick={() => setShowAbout(false)} className="text-gray-500 hover:text-gray-300 text-2xl leading-none">&times;</button>
          </div>
            <div className="space-y-4 text-sm text-gray-400">
              <section>
                <h3 className="font-semibold text-gray-200 mb-1">Two Portals</h3>
              ...
              <section>
                <h3 className="font-semibold text-gray-200 mb-1">Content Source of Truth (JSON Files)</h3>
              ...
              <section>
                <h3 className="font-semibold text-gray-200 mb-1">Card Grid — Zoom Slider</h3>
              ...
              <section>
                <h3 className="font-semibold text-gray-200 mb-1">Count Label (Topics/Chapters/Modules/Subjects)</h3>
              ...
              <section>
                <h3 className="font-semibold text-gray-200 mb-1">Coming Soon / In Progress Ribbon</h3>
              ...
              <section>
                <h3 className="font-semibold text-gray-200 mb-1">Canvas (Localhost Only)</h3>
              ...
              <section>
                <h3 className="font-semibold text-gray-200 mb-1">Animation Steps</h3>
              ...
              <section>
                <h3 className="font-semibold text-gray-200 mb-1">Sub Topics (Progress Tracker)</h3>
              ...
              <section>
                <h3 className="font-semibold text-gray-200 mb-1">Idle Animations (CSS)</h3>
              ...
              <section>
                <h3 className="font-semibold text-gray-200 mb-1">Keyboard Shortcuts</h3>
              ...
              <section>
                <h3 className="font-semibold text-gray-200 mb-1">Export / Import (JSON Backup)</h3>
              ...
              <section>
                <h3 className="font-semibold text-gray-200 mb-1">Present Mode</h3>
              ...
              <section>
                <h3 className="font-semibold text-gray-200 mb-1">Production (Vercel Deploy)</h3>
              ...
              <section>
                <h3 className="font-semibold text-gray-200 mb-1">Site Branding</h3>
              ...
              <section>
                <h3 className="font-semibold text-gray-200 mb-1">Auto-Save</h3>
